...
KMeans::KMeans(int K, int iterations)
{
	...
	this->total_points = 0; //OELK
	this->dimensions = 0; //OELK
}
...
void KMeans::getClusters(vector<Cluster>& _clusters)
{
...
int i = 0;
    ...
    {
    	cout<< "ID: " << all_points[i].getID();
    	cout<< "cluster: " << all_points[i].getCluster() << endl; //"Value: " << all_points[i].getVal(); << endl;
    }
